...
export default class PageController {
  ...
  render(films, comments) {
    ...
    const topRated = sortObjectsByKeyMaxMin(films, `rating`);
    const mostCommented = sortArrayOfArrsFromMaxToMin(comments);
    ...
    render(container, filmsPrimaryList, RenderPosition.BEFOREEND);

    renderBigList(filmsPrimaryList, films);
